...
{
    class HeartRateRangeTarget : IConcreteHeartRateTarget
    {
        ...
        public Byte MinHeartRate
        {
            ...
            set
            {
                ValidateValue(value, MaxHeartRate, IsPercentageMaxHeartRate);
        ...
        public Byte MaxHeartRate
        {
            ...
            set
            {
                ValidateValue(MinHeartRate, value, IsPercentageMaxHeartRate);

...
{
    public class GarminFitnessInt32Range : IPluginSerializable, IXMLSerializable, IComparable<GarminFitnessInt32Range>
    {
...
#region IComparable Members
        ...
        public Int32 Value
        {
            set
            {
                m_Value = (Int32)Utils.Clamp(value, m_MinimumValue, m_MaximumValue);
            }
        }
